...
我是Yigu（POPCORNBOOM），一名充满热情的开发者和技术爱好者。

- 🔭 **兴趣领域**：Coding、摄影、数学与物理原理研究
- 💼 **工作态度**：专注的工作狂，热爱深入钻研技术问题
- 📚 **学习方向**：正在学习MCS、MSE-Physics等多学科知识
- 🌟 **理念**：相信学科融合能带来创新，并致力于实现这一目标
...
| 时间段 | 项目 | 描述 |
|--------|------|------|
| 大二 | [EZHolo简单刮擦](https://github.com/POPCORNBOOM/EZHolodotNet) | 基于深度估算从平面图像创建刮擦全息路径的工具 |
| 高三-大二 | [EzCard](https://github.com/POPCORNBOOM/EZCardDN-demo) | 为桌游开发者服务的集成开发器 |
| 高三 | [M维超立方体计算器](https://github.com/POPCORNBOOM/High-DimensionalHypercubeCalculator) | 推导M维超立方体中含有N维超立方体个数 |
| 高二-高三 | [CardEditor](https://github.com/POPCORNBOOM/CardEditor) | EZCard前身，批量卡牌生成器 |
| 高二 | [逆时巫师官网](https://www.reversewizard.site/) | 为深圳中学自制桌游构建的官方网站 |
| 高二 | [三面骰模拟统计器](https://github.com/POPCORNBOOM/3SidedDice-Coin-with-Unity3D) | IYPT竞赛团队模拟演示软件 |
| 初二 | 应变片测算控制器界面 | 为控制器设计前端交互界面 |
